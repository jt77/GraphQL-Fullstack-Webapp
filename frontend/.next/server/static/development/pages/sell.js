          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                data.append('upload_presets', 'sickfits'); // calling the cloudinary api - an account is required
                ...
                _this.setState({
                  ...
                  image: "./static/shoes/".concat(files[0].name),
                  largeImage: "./static/shoes/".concat(files[0].name)
                });
...
var _jsxFileName = "/Users/Juan/Desktop/tutorials/wesbos/advanced_react/working_files/graphql_fullstack_webapp/frontend/pages/sell.js";
