          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return fetch('https://api.cloudiary.com/v1_1/...', {
                  method: 'POST',
                  body: data
                });
              ...
              case 9:
                ...
                _this.setState({
                  ...
                  image: "./static/".concat(Math.ceil(Math.random() * 6)),
                  largeImage: "./static/".concat(Math.ceil(Math.random() * 6))
                });
...
//# sourceMappingURL=sell.js.12a9ac55887ef48c900c.hot-update.js.map